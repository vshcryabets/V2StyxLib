...
TEST_CASE("testWriteUTFString", "[BufferWritterImpl]") {
    BufferWritterImpl writer(32);
    StyxString str = "Test";
...
TEST_CASE("testWriteAndPrepareBuffer", "[BufferWritterImpl]") {
    BufferWritterImpl writer(32);
}

TEST_CASE("testWriteBufferOverflow", "[BufferWritterImpl]") {
    BufferWritterImpl writer(32);
}